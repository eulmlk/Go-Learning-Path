...
func (_m *TaskRepository) ReplaceTask(id primitive.ObjectID, taskData *domain.Task) error {
...
func (_m *TaskRepository) UpdateTask(id primitive.ObjectID, taskData primitive.M) error {
	ret := _m.Called(id, taskData)
