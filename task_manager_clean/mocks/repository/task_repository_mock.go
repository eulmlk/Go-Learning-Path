...
// ReplaceTask provides a mock function with given fields: id, taskData
func (_m *TaskRepository) ReplaceTask(id primitive.ObjectID, taskData *domain.Task) (*domain.Task, error) {
...
func (_m *TaskRepository) UpdateTask(id primitive.ObjectID, taskData primitive.M) (*domain.Task, error) {
	ret := _m.Called(id, taskData)
	...
	var r0 *domain.Task
	var r1 error
	if rf, ok := ret.Get(0).(func(primitive.ObjectID, primitive.M) (*domain.Task, error)); ok {
		return rf(id, taskData)
	}
	if rf, ok := ret.Get(0).(func(primitive.ObjectID, primitive.M) *domain.Task); ok {
		r0 = rf(id, taskData)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domain.Task)
